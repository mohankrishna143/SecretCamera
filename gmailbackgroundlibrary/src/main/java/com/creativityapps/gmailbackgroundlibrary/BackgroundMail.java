...
public class BackgroundMail {
    ...
    public void setGmailUserName(int strRes) {
    ...
    public void setGmailPassword( int strRes) {
    ...
    public void setType( int strRes) {
    ...
    public void setMailTo( int strRes) {
    ...
    public void setMailCc( int strRes) {
    ...
    public void setMailBcc( int strRes) {
    ...
    public void setSubject( int strRes) {
    ...
    public void setBody( int strRes) {
    ...
    public void setSendingMessage( int strRes) {
    ...
    public void setSendingMessageSuccess( int strRes) {
    ...
    public void setSendingMessageError( int strRes) {
    ...
    public void addAttachment( int strRes) {
    ...
    public static final class Builder {
        ...
        public Builder withUsername( int usernameRes) {
        ...
        public Builder withPassword( int passwordRes) {
        ...
        public Builder withMailTo( int mailToRes) {
        ...
        public Builder withMailCc( int mailCcRes) {
        ...
        public Builder withMailBcc( int mailBccRes) {
        ...
        public Builder withSubject( int subjectRes) {
        ...
        public Builder withType( int typeRes) {
        ...
        public Builder withBody( int bodyRes) {
        ...
        public Builder withAttachments( int attachmentsRes) {
            this.attachments.addAll(Arrays.asList(context.getResources().getStringArray(attachmentsRes)));
            return this;
        }

        public Builder withSendingMessage( String sendingMessage) {
            this.sendingMessage = sendingMessage;
            return this;
        }

        public Builder withSendingMessage( int sendingMessageRes) {
            this.sendingMessage = context.getResources().getString(sendingMessageRes);
            return this;
        }

        public Builder withSendingMessageSuccess( String sendingMessageSuccess) {
            this.sendingMessageSuccess = sendingMessageSuccess;
            return this;
        }

        public Builder withSendingMessageSuccess( int sendingMessageSuccessRes) {
            this.sendingMessageSuccess = context.getResources().getString(sendingMessageSuccessRes);
            return this;
        }

        public Builder withSendingMessageError( String sendingMessageError) {
            this.sendingMessageError = sendingMessageError;
            return this;
        }

        public Builder withSendingMessageError( int sendingMessageError) {
