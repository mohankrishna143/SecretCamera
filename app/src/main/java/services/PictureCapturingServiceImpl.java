...
import com.android.krishsecretcamera.R;
 ...
 *
 * @author krishna (kmohankrishna592@gmail.com)
 */
...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void takePicture() throws CameraAccessException {
        ...
        int width = jpegSizesNotEmpty ? jpegSizes[2].getWidth() : 640;
        int height = jpegSizesNotEmpty ? jpegSizes[2].getHeight() : 480;
    ...
    private  boolean getPreferenceData(String type){
        SharedPreferences sp = context.getSharedPreferences(context.getResources().getString(R.string.app_name), 0);
